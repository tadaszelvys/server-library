...
use OAuth2\Response\Factory\ResponseFactoryInterface;
...
final class OAuth2ResponseFactoryManager
{
    ...
    /**
     * @var \OAuth2\Response\Extension\ExtensionInterface[]
     */
    private $extensions = [];

    /**
     * @var \OAuth2\Response\Factory\ResponseFactoryInterface[]
     */

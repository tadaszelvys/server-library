...
final class IssuerDiscoveryEndpoint implements MiddlewareInterface
{
     ...
     *
     * @param ResourceManagerInterface $resourceManager The Resource Manager
     * @param ResponseFactoryInterface $responseFactory The Response Factory
     * @param UriFactoryInterface      $uriFactory      The Uri Factory
     * @param UriInterface             $server          The server URI of this discovery service
     */
    public function __construct(ResourceManagerInterface $resourceManager, ResponseFactoryInterface $responseFactory, UriFactoryInterface $uriFactory, UriInterface $server)
    {
